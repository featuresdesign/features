<?php include_once "_header.php"; ?>
                    ...
                    <div class="swiper-slide dark">
                        <div class="container clearfix">
                            <div class="slider-caption slider-caption-center">
                                <h2 data-caption-animate="fadeInUp">DESIGN E INOVAÇÃO DIGITAL</h2>
                                <p class="d-none d-sm-block" data-caption-animate="fadeInUp" data-caption-delay="200">
                                    COM AS FEATURES QUE DIFERENCIAM.
                                </p>
                            </div>
                        </div>
    ...
    <section id="content">
        ...
        <div class="button button-full button-dark center tright bottommargin-lg">
            <div class="container clearfix">
                QUER SABER COMO PODEMOS AJUDAR SUA EMPRESA?<br>
                <div class="m-top-50" data-caption-animate="fadeInUp" data-caption-delay="300">
                    <form>
                        <div class="row">
                            <div class="col-md-3"></div>
                            <div class="input-group mb-3 col-md-6">
                                <input type="email" name="email" id="email" placeholder="Digite seu E-mail para mais informações" class="form-control">
                                <div class="input-group-append">
                                    <button class="btn btn-email" type="button">Enviar</button>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <div class="section topmargin nobottommargin nobottomborder m-t-70">
            <div class="container clearfix">
        ...
        <div class="content-wrap">
            ...
            <div class="container clearfix">
                <div class="row clearfix">
                    ...
                    <div class="col-xl-5">
                        ...
                        <p class="lead">
                            A PRESENÇA DIGITAL É PARTE ESSENCIAL DA ESTRATÉGIA DE CRESCIMENTO DO FATURAMENTO DAS
                            EMPRESAS.
                        </p>
                    </div>
            ...
            <div class="container clearfix m-top-200">
            ...
            <div class="container clearfix m-top-100" id="contato">
